...
/**
 * This is the item provider adapter for a {@link timetrack.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_number_feature", "_UI_Project_type"),
				 TimetrackPackage.Literals.PROJECT__NUMBER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TimetrackPackage.Literals.PROJECT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Project.class)) {
			case TimetrackPackage.PROJECT__NUMBER:
			case TimetrackPackage.PROJECT__NAME:

...
import timetrack.presentation.TimetrackEditorPlugin;
 ...
 * @generated
 */
public final class TimetrackEditorAdvisor extends WorkbenchAdvisor {
	/**
	 ...
	 * @generated
	 */
	private static final String[] FILE_EXTENSION_FILTERS = TimetrackEditor.FILE_EXTENSION_FILTERS.toArray(new String[0]); 
	...
	private static String getString(String key) {
		return TimetrackEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return timetrack.presentation.TimetrackEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new TimetrackEditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "timetrack.presentation.TimetrackEditorAdvisorPerspective";
	...
	/**
	 * Open action for the objects from the Timetrack model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Timetrack model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public void initialize(IWorkbenchConfigurer configurer) {
		...
		props.setProperty(Environment.URL,
				"jdbc:hsqldb:file://C:/hsqldb/dbs/timetrack;shutdown=true;hsqldb.write_delay=false");
		...
		hbds.setEPackages(new EPackage[] { TimetrackPackage.eINSTANCE });
		hbds.initialize();
		...
		try {
			...
			if (resource.getContents().size() == 0) {
				resource.getContents().add(
						TimetrackFactory.eINSTANCE.createLibrary());
				resource.save(null);
			}
		} catch (IOException e) {
				...
				try {
					PlatformUI
							...
							.openEditor(new URIEditorInput(uri),
									"timetrack.presentation.TimetrackEditorID");
